...
export function LeadForm({ locale }: { locale: Locale }) {
  ...
  if (submitted) {
    return (
      <div className="flex min-h-screen items-center justify-center px-4" style={{ backgroundColor: "#404040" }}>
  ...
  return (
    <div className="flex min-h-screen items-start sm:items-center justify-center px-4 py-8 sm:py-12" style={{ backgroundColor: "#404040", minHeight: "100vh" }}>
